package ru.at_consulting.autotest.api;
...
public interface Client extends Tool {
   ...
   * @see             Profile
   */
  Request prepareRequest(String requestId) throws PrepareRequestException;
   ...
   * @see             Profile
   */
  Response sendRequest(Request request) throws SendRequestException;
