...
import gfTool.SMTPClient.SMTPClient;
import gfTool.SMTPClient.SMTPProfile;
import gfTool.SMTPClient.SMTPRequest;
    ...
    public void initialize(URL fxmlFileLocation, ResourceBundle resources) {
        ...
        smtpButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                SaveAndOpen.projectGlobalSave(System.getenv("GFTOOL_ROOT") + "/serz/smtp.tab.objects", smtpMainTabPane, SMTPTabController.this);
        ...
        SaveAndOpen.projectGlobalOpen(System.getenv("GFTOOL_ROOT") + "/serz/smtp.tab.objects", smtpMainTabPane, SMTPTabController.this);
